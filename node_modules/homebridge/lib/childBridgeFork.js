...
class ChildBridgeFork {
    ...
    async startBridge() {
        ...
        if (this.type === "platform" /* PLATFORM */) {
            ...
            const displayName = ((_a = this.pluginConfig) === null || _a === void 0 ? void 0 : _a.name) || plugin.getPluginIdentifier();
            const logger = logger_1.Logger.withPrefix(displayName);
            const constructor = plugin.getPlatformConstructor(this.identifier);
            const platform = new constructor(logger, this.pluginConfig, this.api);
            ...
            const accessoryInstance = new constructor(logger, this.pluginConfig, this.api);
