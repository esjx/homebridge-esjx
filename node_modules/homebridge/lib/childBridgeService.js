...
class ChildBridgeService {
    constructor(type, identifier, plugin, pluginConfig, bridgeConfig, homebridgeConfig, homebridgeOptions, api, ipcService, externalPortService) {
        var _a;
        this.type = type;
        ...
        this.log = logger_1.Logger.withPrefix(((_a = this.pluginConfig) === null || _a === void 0 ? void 0 : _a.name) || this.plugin.getPluginIdentifier());
        this.args = [];
    ...
    startChildProcess() {
        ...
        this.child.on("message", (message) => {
            ...
            switch (message.id) {
                case "ready" /* READY */: {
                    this.log(`Launched external bridge with PID ${(_a = this.child) === null || _a === void 0 ? void 0 : _a.pid}`);
                    this.loadPlugin();
                    break;
                }
                case "loaded" /* LOADED */: {
    ...
    async refreshConfig() {
        ...
        try {
            ...
            if (this.type === "platform" /* PLATFORM */) {
                const config = (_a = homebridgeConfig.platforms) === null || _a === void 0 ? void 0 : _a.find(x => { var _a; return x.platform === this.identifier && ((_a = x._bridge) === null || _a === void 0 ? void 0 : _a.username) === this.bridgeConfig.username; });
                if (config) {
                ...
                const config = (_b = homebridgeConfig.accessories) === null || _b === void 0 ? void 0 : _b.find(x => { var _a; return x.accessory === this.identifier && ((_a = x._bridge) === null || _a === void 0 ? void 0 : _a.username) === this.bridgeConfig.username; });
                if (config) {
                    this.pluginConfig = config;
                    this.bridgeConfig = this.pluginConfig._bridge || this.bridgeConfig;
                }
