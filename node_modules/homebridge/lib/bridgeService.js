...
class BridgeService {
    ...
    static printCharacteristicWriteWarning(plugin, accessory, warning) {
    ...
    async handlePublishExternalAccessories(accessories) {
        ...
        for (const accessory of accessories) {
            ...
            if (plugin) {
                ...
                hapAccessory.on("characteristic-warning" /* CHARACTERISTIC_WARNING */, BridgeService.printCharacteristicWriteWarning.bind(this, plugin, hapAccessory));
            }
