...
export declare class ChildBridgeService {
    ...
    constructor(type: PluginType, identifier: string, plugin: Plugin, pluginConfig: PlatformConfig | AccessoryConfig, bridgeConfig: BridgeConfiguration, homebridgeConfig: HomebridgeConfig, homebridgeOptions: HomebridgeOptions, api: HomebridgeAPI, ipcService: IpcService, externalPortService: ExternalPortService);
